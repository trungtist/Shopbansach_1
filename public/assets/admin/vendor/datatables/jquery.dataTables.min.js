...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Đầu",sLast:"Cuối",sNext:"Sau",sPrevious:"Trước"},sEmptyTable:"không có dữ liệu trong bảng",sInfo:"Hiển thị _START_ đến _END_ trong số _TOTAL_ hàng",sInfoEmpty:"Hiển thị 0 đến 0 trong số 0 hàng",
sInfoFiltered:"(được lọc từ _MAX_ hàng)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Xem _MENU_ hàng",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Tìm kiếm:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Không tìm thấy kết quả"},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
