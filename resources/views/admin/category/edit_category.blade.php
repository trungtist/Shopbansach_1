    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form id="edit" action="" method="POST">
                @csrf
                <input type="text" id="MaTheLoai" hidden value="{{ $category->MaTheLoai }}">
                <div class="form-group row">
                    <label for="TenTheLoai" class="control-label col-md-2">Tên thể loại (<font style="color:red">*</font>
                        )</label>
                    <div class="col-sm-8">
                        <input type="text" id="TenTheLoai" name="TenTheLoai" value="{{ $category->TenTheLoai }}"
                    ...
                    <div class="col-md-8">
                        <select name="MaLoai" id="MaLoai" class="form-control">
                            @foreach ($type_books as $key => $item)
                                @if ($item->MaLoai == $category->MaLoai)
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input type="number" id="Level" name="Level" class='form-control' value="{{ $category->Level }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input type="number" id="Status" name="Status" class='form-control' value="{{ $category->Status }}">
                ...
                <div class="form-group row">
                    <div class="col-sm-8">
                        <input type="button" id="update_pro" value="Cập nhật" class="btn btn-primary" />

                        <a href="/admin/category/manage" class="btn btn-secondary btn-icon-split">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#update_pro').on('click', function(event) {
                ...
                if (check == 0) {
                    let MaTheLoai = $('#MaTheLoai').val();
                    $.ajax({
                        url: '/admin/category/edit/' + MaTheLoai,
                        type: 'post',
                        dataType: 'json',
                        data: $("#edit").serialize(),
