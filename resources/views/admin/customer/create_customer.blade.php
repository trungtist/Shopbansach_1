        ...
        <div class="card-body">
            <form id="create" action="" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" id="HoTen" name="HoTen" value="" class='form-control'>
                ...
                <div class="form-group row">
                    <div class="col-sm-8">
                        <input id="add_customer" name="smb" type="button" value="Thêm" class="btn btn-primary" />
    ...
    <script>
        $(document).ready(function() {
            $('#MatKhau').on('input', function() {
                ...
                if (a == '' || a.length > MAX_LENGTH_PASS || !pw.test(a)) {
                        ...
                        success: function(data) {
                            if (data.code == 200) {
                                Swal.fire({
                                    ...
                                    location.href = '/admin/customer/manage';
                                });
                            } else {
                                Swal.fire({
