    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form id="edit" action="" method="POST">
                @csrf
                <input type="text" hidden id="MaTacGia" value="{{ $author->MaTacGia }}">
                <div class="form-group row">
                    <label for="TenTacGia" class="control-label col-md-2">Tên tác giả (<font style="color:red">*</font>
                        )</label>
                    <div class="col-sm-8">
                        <input type="text" id="TenTacGia" name="TenTacGia" value="{{ $author->TenTacGia }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" id="DiaChi" name="DiaChi" value="{{ $author->DiaChi }}" class='form-control'
                            require>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" id="TieuSu" name="TieuSu" value="{{ $author->TieuSu }}" class='form-control'
                            require>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="number" id="DienThoai" name="DienThoai" value="{{ $author->DienThoai }}"
                            class='form-control'>
                ...
                <div class="form-group row">
                    <label for="Status" class="control-label col-md-2">Trạng thái (1-Còn tương tác, 0-Không tương tác) (
                        <font style="color:red">*</font>)
                    </label>
                    <div class="col-md-8">
                        <input type="number" id="Status" name="Status" class='form-control' value="{{ $author->Status }}">
                ...
                <div class="form-group row">
                    <div class="col-sm-8">
                        <input name="smb" type="button" id="update_Au" value="Cập nhật" class="btn btn-primary" />
                        <a href="/admin/author/manage" class="btn btn-secondary btn-icon-split">
...
@section('js')
    <script>
        $(document).ready(function() {
            ...
            $('#update_Au').on('click', function(event) {
                ...
                if (check == 0) {
                    ...
                    $.ajax({
                        url: '/admin/author/edit/' + MaTacGia,
                        type: 'post',
                        dataType: 'json',
                        data: $("#edit").serialize(),
