    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form id="create" action="" enctype="multipart/form-data" method="POST">
                @csrf
                <input type="text" hidden value="{{ $new->id }}" id="id_new" name="id_new">
                ...
                <textarea name="new_content" hidden id="new_content" cols="30" rows="10">{{ $new->content }}</textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                        <img class="mt-1" width="100"
                            src="{{ asset('assets/client/images_new/' . $new->image) }}">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input type="number" id="Status" name="Status" class='form-control' value="{{ $new->status }}">
                ...
                <div class="form-group row">
                    <div class="col-sm-8">
                        <input name="bsm" type="button" id="edit_new" value="Cập nhật" class="btn btn-primary" />
                        <a href="/admin/new/manage" class="btn btn-secondary btn-icon-split">
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var HTMLstring = $('#new_content').val();
            $('#summenote').summernote('code', HTMLstring);
            ...
            $('#edit_new').on('click', function(event) {
