    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form id="edit" action="" method="POST">
                @csrf
                <input type="text" hidden id="MaNXB" value="{{ $supplier->MaNXB }}">
                <div class="form-group row">
                    <label for="TenNXB" class="control-label col-md-2">Tên nhà xuất bản (<font style="color:red">*</font>
                        )</label>
                    <div class="col-sm-8">
                        <input type="text" id="TenNXB" name="TenNXB" value="{{ $supplier->TenNXB }}" class='form-control'
                            require>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" id="DiaChi" name="DiaChi" value="{{ $supplier->DiaChi }}" class='form-control'
                            require>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="number" id="DienThoai" name="DienThoai" value="{{ $supplier->DienThoai }}"
                            class='form-control'>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input type="number" id="Status" name="Status" class='form-control' value="{{ $supplier->Status }}">
                ...
                <div class="form-group row">
                    <div class="col-sm-8">
                        <input name="smb" type="button" id="update_producer" value="Cập nhật" class="btn btn-primary" />
                        <a href="/admin/supplier/manage" class="btn btn-secondary btn-icon-split">
...
@section('js')
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#update_producer').on('click', function() {
                let check = 0;
                let a = $(`#TenNXB`).val();
                if (a == "") {
                    $(`#TenNXB`).addClass("is-invalid");
