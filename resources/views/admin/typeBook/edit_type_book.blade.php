...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Chỉnh sửa loại</h6>
        </div>
        <div class="card-body">
            <form id="edit" action="" method="POST">
                @csrf
                <input type="text" hidden id="MaLoai" value="{{ $type_book->MaLoai }}">
                <div class="form-group row">
                    <label for="TenLoai" class="control-label col-md-2">Tên loại (<font style="color:red">*</font>)</label>
                    <div class="col-sm-8">
                        <input type="text" id="TenLoai" name="TenLoai" value="{{ $type_book->TenLoai }}"
                    ...
                    <div class="col-md-8">
                        <select name="MaChuDe" id="MaChuDe" class="form-control">
                            @foreach ($theme_books as $key => $item)
                                @if ($item->MaChuDe == $type_book->MaChuDe)
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input type="number" id="Level" name="Level" class='form-control' value="{{ $type_book->Level }}"
                            required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input type="number" id="Status" name="Status" class='form-control'
                            value="{{ $type_book->Status }}" required>
                ...
                <div class="form-group row">
                    <div class="col-sm-8">
                        ...
                        <a href="/admin/type_book/manage" class="btn btn-secondary btn-icon-split">
        ...
        $(document).ready(function() {
            ...
            $('#update_pro').on('click', function(event) {
                ...
                if (check == 0) {
                    ...
                    $.ajax({
                        url: '/admin/type_book/edit/' + MaLoai,
                        type: 'post',
                        dataType: 'json',
                        data: $("#edit").serialize(),
